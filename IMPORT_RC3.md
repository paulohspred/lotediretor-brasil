...
4. Confirme o upload em **Commit changes** diretamente na branch `main`.
...
- extrair a pasta `LoteDiretor_SaaS_v19_RC3` para a raiz do repositório;
- confirmar `VERSION = 19.0.0-rc.3`;
- verificar integralmente `FILE_MANIFEST.sha256`;
- remover o ZIP do histórico corrente e remover este bootstrap temporário;
...
O hash esperado do pacote é:

`d82e19f6122bc6231da92a22c47ff7b07b287598762684fa2388218383368fab`

Se o hash não corresponder, o workflow para sem importar o conteúdo.

...
@Module({imports:[CoreModule,TerritorialModule,Property360Module,ReportModule,RuralModule,CondoModule,SolarModule,DomainsModule,MetricsModule,ContractsModule,JobEventsModule]})

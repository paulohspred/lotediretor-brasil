...
const base={viabilityStatus:'PERMITTED',hasRules:true,hasSpatialEvidence:false,legalTemporalConflictCount:0,legalTemporalUnknownCount:0,legalTemporalPendingCount:0};
...
assert.equal(deriveAnalysisRunStatus({...base,legalTemporalPendingCount:1}),'NEEDS_REVIEW');

...
python tests/validate_v10_contracts.py
...
JS
bash -n ops/db/bootstrap-runtime-roles.sh ops/rls/runtime-isolation.sh ops/runtime/production-preflight.sh ops/runtime/wait-healthy.sh ops/runtime/acceptance.sh ops/runtime/smoke.sh ops/backup/backup.sh ops/backup/restore-drill.sh validate-v10.sh start.sh
echo 'v10 static/domain/runtime-contract validation OK'

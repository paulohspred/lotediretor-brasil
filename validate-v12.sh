...
python tests/validate_v12_contracts.py
...
JS
bash -n ops/runtime/*.sh ops/rls/*.sh ops/backup/*.sh ops/db/*.sh ops/release/*.sh validate-v12.sh
echo 'v12 static/domain/observability validation OK'

...
# RC3 contract remains explicit here even though the v20 mapping is generated by
# index_schema.py. Keeping this executable guard prevents a shared-schema
# refactor from silently relaxing strict evidence-index field validation.

...
# silently relaxing the retained public/private retrieval safety contract.
STRICT_DYNAMIC_MAPPING_CONTRACT={'dynamic':'strict'}
RC3_INDEX_FIELD_CONTRACT={'visibility':{'type':'keyword'},'retrieval_allowed':{'type':'boolean'}}
...
def ensure_index():
    ...
    for field,expected in RC3_INDEX_FIELD_CONTRACT.items():
        if generated_properties.get(field)!=expected:
